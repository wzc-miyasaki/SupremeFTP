...
//         if(receivedCount > packet_count * 1.9){
//             break; 
//         }
//     }
//     usleep (1000);  
...
//     tv.tv_usec = 450000; // 0 microseconds
...
//     tiemfoTrans = difftime(now, start);
//     if (numOfLoss > 0) {
//         cout << "Loss detected, start retransmission" << endl;

//         for (int i = 1; i <= packet_count && numOfLoss > 0; i+=1) {
//             while(ack[i] == 0) { 
//                 memset (&packet, 0, sizeof (packet));
...
//                     cout << "transmission received: " << packet_count - initialLoss << "tiem: " << tiemfoTrans << endl; 
//                 }
//             }
//         }
//     } 
    ...
    for (int i = 1; i <= packet_count; i+=1) {
        while(ack[i] == 0) { 
            ...
            while(true){
                ...
                cout << "===========" << endl;
                cout << "Time consumed: " << diff << endl; 
                cout << "transmission received: " << packet_count - initialLoss << endl; 
            }
        }
    }
